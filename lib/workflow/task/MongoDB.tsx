  ...
  inputs: [
    {
      ...
      options: [
        ...
        { label: "Analytics & Insights", value: "analytics" },
      ],
    ...
    {
      name: "DataViewer",
      type: TaskParamType.DATA_VIEWER,
      required: false,
      hideHandle: true,
      helperText: "View data directly in the node",
    },
    {
      name: "Document",
    ...
    },
    {
      ...
      required: false,
      hideHandle: false,
      helperText: "Input data from previous nodes (e.g., Google Sheets)",
    },
    {
      name: "Query",
      type: TaskParamType.TEXTAREA,
