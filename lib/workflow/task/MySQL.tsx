...
export const MySQLTask = {
  type: TaskType.MYSQL,
  label: "MySQL",
  icon: (props: LucideProps) => <Database {...props} className="stroke-blue-600" />,
  isEntryPoint: false,
  inputs: [
    {
      name: "Action",
      ...
      helperText: "Choose the MySQL operation",
    },
    {
      name: "Query",
    ...
    },
    {
      ...
      required: true,
      hideHandle: true,
      helperText: "MySQL connection credentials",
    },
  ],
  outputs: [
    {
