...
import { QueryExecutor, InsertExecutor, UpdateExecutor, DeleteExecutor } from "./MySQL";

export async function MySQLExecutor(
  enviornment: ExecutionEnviornment<WorkflowTask & { type: TaskType.MYSQL }>
): Promise<boolean> {
