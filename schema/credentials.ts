...
export interface ICredential {
  ...
  userId: string;
  name: string;
  type: "GMAIL" | "SLACK" | "OPENAI" | "NOTION" | "DISCORD" | "GITHUB" | "GOOGLE_SHEETS" | "ANTHROPIC" | "HUGGING_FACE" | "WEBHOOK" | "HTTP" | "CUSTOM";
...
const CredentialSchema = new mongoose.Schema<ICredential>({
  ...
  type: {
    type: String,
    enum: ["GMAIL", "SLACK", "OPENAI", "NOTION", "DISCORD", "GITHUB", "GOOGLE_SHEETS", "ANTHROPIC", "HUGGING_FACE", "WEBHOOK", "HTTP", "CUSTOM"],
    required: true,
  },
  value: {
    type: String,
